    ...
    <div className="w-full items-start text-lip_text overflow-hidden">
      <div className="lg:px-[6.25rem] md:px-8 px-5 text-left">
        ...
        <div className="lg:block hidden">
          <div className="mt-7">
            <ul className="flex font-semibold text-[0.875rem]">
              ...
              <li className="mr-4 font-light text-lip_gray">|</li>
              <li className="text-lip_sodomy mr-4">개인정보처리방침</li>
              <li className="mr-4 font-light text-lip_gray">|</li>
              <li>운영정책</li>
            </ul>
          </div>
          <div className="mt-4 text-left text-[0.8125rem] flex w-full justify-between items-end">
            ...
            <a href="mailto:#">
              <div className="pl-6 pr-3 py-2 border border-lip_gray rounded-full flex items-center flex-shrink-0">
                <p className="text-[0.8125rem] mr-10">
                  궁금한 내용이 있으신가요?
                </p>
                <button className="px-7 py-3 bg-lip_black text-lip_white font-bold text-[0.875rem] rounded-full">
                  이메일 문의하기
                </button>
              </div>
            </a>
        ...
        <div className="items-start lg:hidden md:block hidden">
          {/* 버튼 & 이미지 */}
          <a href="mailto:#">
            <div className="w-full text-3 pl-3 pr-1 py-1 border border-lip_gray rounded-full flex justify-between items-center flex-shrink-0 mt-6">
              <p className="text-[0.8125rem]">궁금한 내용이 있으신가요?</p>
              <button className="px-6 py-3 bg-lip_black text-lip_white font-bold text-[0.8125rem] rounded-full">
                이메일 문의하기
              </button>
            </div>
          </a>
          ...
          >
            <div className="mt-4">
              <ul className="flex font-semibold text-[0.6875rem]">
                ...
                <li className="mr-2 font-light text-lip_gray">|</li>
                <li className="text-lip_sodomy mr-2">개인정보처리방침</li>
                <li className="mr-2 font-light text-lip_gray">|</li>
                <li>운영정책</li>
              </ul>
            </div>
      ...
      <div className="lg:mt-[3.75rem] mt-3 lg:px-[6.25rem] md:px-8 px-5 lg:text-center md:text-left text-left">
        <hr className="border-lip_gray w-full lg:opacity-100 md:opacity-0 opacity-0" />
